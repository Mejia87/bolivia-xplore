...
export default function SettingsScreen() {
    const [notificationRecommendations, setNotificationRecommendations] =
        useState(false);
    ...
    useEffect(() => {
        setNotificationRecommendations(
            user.preferences.notificationRecomendation
        );
    ...
    const updatePreferences = async () => {
        ...
        try {
            const response = await fetch(
                `${API_BASE_URL}/api/user/updatepreferences`,
                {
                    method: "PUT",
                    headers: {
            ...
            Alert.alert(
                "Error",
                "Ocurrió un problema al actualizar las preferencias."
            );
            console.error(error);
        }
    };
            ...
            <View>
                ...
                <View style={styles.optionContainer}>
                    ...
                    <NumericInput
                        ...
                        customPlusIcon={<Icon name="add" type="material" color="black" size={20} />}
                        customMinusIcon={<Icon name="remove" type="material" color="black" size={20} />}
                      />
                </View>
                ...
                <View style={styles.optionContainer}>
                    ...
                    <Switch
                        ...
                        onValueChange={(e) => {
                            setNotificationRecommendations(e);
                            doSomething();
                        }}
                    />
                </View>
